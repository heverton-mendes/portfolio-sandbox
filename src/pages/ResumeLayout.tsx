  ...
  return (
    <main className="container-max py-20 min-h-[80vh]">
      ...
      <div className="flex flex-col items-center text-center mt-8">
        ...
        {/* Botão de Download */}
        <a 
          href={language === 'en' ? "/resume/heverton-resume-en.pdf" : "/resume/heverton-resume-pt.pdf"}
        ...
        <div className="w-full max-w-4xl bg-white rounded overflow-hidden shadow-composite border border-dashed border-border-default p-2">
          <iframe 
            src={language === 'en' ? "/resume/heverton-resume-en.pdf" : "/resume/heverton-resume-pt.pdf"}
